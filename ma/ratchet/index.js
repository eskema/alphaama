// alphaama with the dr (double ratchet) module enabled
//
// dr is NOT in aa.mods by default — this page opts in via the mods override.
// d.scripts handles loading /dep/ratchet.js + /d/mk.js, and d.styles loads /d/d.css.
// after aa.load resolves, d is fully integrated and aa.d.l is its UI element.

aa.load({
  mods: [...aa.mods, ['d','/d/d.js']],
}).then(() => whateverthefuckyouwant());
